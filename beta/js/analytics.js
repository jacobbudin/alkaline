...
window.onload = function () {
    ...
    var labels = [],
        data = [];
    $("#statistics_data tfoot th").each(function () {
        labels.push($(this).html());
    });
    $("#statistics_data tbody td").each(function () {
        data.push($(this).html());
    });
    ...
    var width = 910,
        ...
        r = Raphael("statistics_holder", width, height),
        txt = {font: '12px "Helvetica Neue", Helvetica, Arial', fill: "#ccc"},
        txt1 = {font: '10px "Helvetica Neue", Helvetica, Arial', fill: "#fff"},
        txt2 = {font: '12px "Helvetica Neue", Helvetica, Arial', fill: "#000"},
    ...
    label.hide();
    var frame = r.popup(100, 100, label).attr({fill: "#000", stroke: "#474747", "stroke-width": 0, "fill-opacity": .7}).hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                dot.attr("r", 0).attr({stroke: color});
