...
<p id="tags" class="center">
	...
	foreach($tags as $tag){
		$tags_html[] = '<a href="' . BASE . ADMIN . 'search' . URL_ACT . 'tags' . URL_AID . $tag['id'] . URL_RW . '" style="font-size: ' . $tag['size'] . 'em;">' . $tag['name'] . '</a></span> <span class="small quiet">(' . $tag['count'] . ')</span>';
	}
